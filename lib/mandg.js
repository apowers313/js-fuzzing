...
class MorGBase extends Function {
    constructor(name, fn, opts) {
        ...
        return new Proxy(this, {
            apply: (target, thisArg, argumentsList) => {
                this.fn.apply(this, argumentsList);
            }
        });
    }
     ...
     */
    createContext() {
        // return new MandGTypeManager().getContext();
        return {
            get utils() {
                return new MandGTypeManager().utils;
            }
        };
        // var ctx = new MandGTypeManager();
        // console.log ("creating context");
        // console.log ("ctx utils:", ctx.utils);
        // // console.log ("root:", ctx.root);
        // console.log ("ctx generateAny:", ctx.generateAny);
        // return ctx;
    }
...
class MandGTypeManager {
    constructor(opts) {
        ...
        this.utils = new Proxy({}, {
            get: (target, property) => {
                if (this.typeIndex[property] === undefined) return undefined;
                return this.typeIndex[property].utils;
            }
        });
